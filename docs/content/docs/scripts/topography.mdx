...
`scripts/art/topography.py` — cartographic living-art renderer backed by `scripts/art/shared/`.
...
| `.github/assets/img/living-art-manifest.json` | Manifest regenerated from a validated, complete six-style canonical GIF fleet |
| `.github/assets/img/living-art-preview.html` | Preview gallery regenerated from that same validated manifest |
