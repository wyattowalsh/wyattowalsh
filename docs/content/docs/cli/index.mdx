...
<Cards>
  ...
  <Card href="/docs/cli/auth" title="auth">
    Run one-time provider auth helpers such as the Spotify refresh-token bootstrap
  </Card>
...
| Subcommand | Description |
|---|---|
| `spotify-refresh-token` | Run the Spotify loopback auth flow and print a refresh token for CI |
