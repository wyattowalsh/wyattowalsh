...
| `word_clouds/solvers.py` | ~570 | Generic mealpy wrapper + aesthetic cost function; 180 curated optimizers (33 excluded via benchmark) | `_META_SOLVERS`, `_aesthetic_cost()` |
