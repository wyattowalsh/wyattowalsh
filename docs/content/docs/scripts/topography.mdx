...
Topography has a stricter split between authored animation and export-safe output than the rest of the living-art suite:
...
| File | Meaning |
|---|---|
| `.github/assets/img/topo-growth-animated.svg` | Stacked timeline SVG used as the rich source artifact |
| `.github/assets/img/topo-growth.gif` | GitHub-safe compatibility preview |
| `.github/assets/img/living-topo.gif` | Day-by-day timelapse export |
...
<Cards>
  ...
  <Card href="/docs/scripts/living-art-modes" title="Living Art Modes">
    Preview, export, and compatibility constraints for the six-style suite
  </Card>
</Cards>
