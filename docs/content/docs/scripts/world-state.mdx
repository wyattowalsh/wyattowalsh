...
| Genetic Landscape | Terrain contour tint, atmospheric haze, and population/speciation accent pressure |
| Physarum | Substrate humidity, vein glow, exploration tempo, and environmental density |
| Lenia | Field background tone, organism vitality, glow strength, and colony spread |
| Ferrofluid | Pool palette, metallic reflection contrast, spike intensity, and iridescent hue drift |
...
The same `WorldState` drives every living-art generator, but each renderer expresses it differently. A stormy night may become foggy ridges in Topography, denser canopies in Ink Garden, brighter transport veins in Physarum, more dramatic Lenia glow, or higher-contrast spike reflections in Ferrofluid.
</Callout>
