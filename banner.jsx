  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(135deg, #EBF8FF, #D1EEFC)",
    ...
    >
      <div style={{ display: "flex" }}>
        <svg
          ...
          style={{
            width: "180px",
            height: "180px",
            filter: "drop-shadow(6px 12px 16px rgba(0, 0, 0, 0.3))",
          }}
        >
            <g>
      ...
      <GradientText gradient="linear-gradient(to right, #6a9fb5, #88c5d0)">
        Hello, GitHub!
      </GradientText>
      <div
        style={{
