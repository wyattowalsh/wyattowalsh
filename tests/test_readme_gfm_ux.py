...
pytestmark = pytest.mark.skip(
    reason=(
        "Requires README generated by full pipeline — content not present in"
        " base README"
    )
)
...
def test_living_art_in_dropdown():
    """Living-art mapping should render inside a disclosure block."""
    txt = _read_readme()
    ...
    assert before != -1 and after != -1, (
        "Expected living-art mapping inside a <details> disclosure"
    )
