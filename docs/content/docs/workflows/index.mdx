...
- QR code — `generate qr`
- Word cloud by topic — `generate word-cloud --from-topics-md` → `wordcloud_wordle_by_topics.svg`
- Word cloud by language — `generate word-cloud --from-languages-md` → `wordcloud_wordle_by_languages.svg`
